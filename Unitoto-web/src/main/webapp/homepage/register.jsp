...
<div class="row">
    ...
    <div class="col-md-5">
        <img src="${path}/common/css/img/TroyeSivan.jpeg" class="img-responsive" alt="Responsive image">
    </div>
    <div class="col-md-4">
        <div class="panel panel-default">
            <img src="${path}/common/css/img/Unitoto.png" class="img-responsive center-block" alt="Responsive image">
            <div class="panel-body">
                <form>
                    <div class="form-group">
                        <input id="userName" type="text" class="form-control" placeholder="昵称" aria-describedby="basic-addon1">
                    </div>
                    <div class="form-group">
                        <input id="userID" type="text" class="form-control" placeholder="账号" aria-describedby="basic-addon1">
                    </div>
                    <div class="form-group">
                        <input id="userPassword" type="text" class="form-control" placeholder="密码" aria-describedby="basic-addon1">
                    </div>
